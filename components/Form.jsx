...
const Form = ({type,
    ...
    handleSubmit}) => {
  return (
    <section className='w-full mx-w-full flex flex-col flex-start'>
        ...
        <form onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
            <label htmlFor=""> <span className='font-satoshi font-semibold text-base text-gray-700'>Your AI Prompt</span></label>
            ...
            <label htmlFor=""> <span className='font-satoshi font-semibold text-base text-gray-700'>Tag{" "}<span className='font-normal'>(#product,#webdevelopment,#idea)</span></span></label>
            ...
            <div className='flex-end mx-3 mb-5 gap-4'>
                ...
                <button type='submit' disabled={submitting} className='px-5 text-sm py-1.5 text-white bg-primary-orange rounded-full'>
